...
from ...models.responses import SystemStatusResponse, StatusEnum
from ...core.dependencies import get_backend_adapter, get_audio_processor
from ...core.interfaces import BackendInterface, AudioProcessorInterface
...
async def health_check(
    ...
    try:
        ...
        system_healthy = (
            backend_status.get("status") in ["healthy", "operational"] and
            audio_info.get("is_available", False)
        )
