...
from ...core.interfaces import BackendInterface, ConversationInterface
from ...core.dependencies import get_backend_adapter, get_conversation_service
from ...core.exceptions import BackendCommunicationException, ValidationException
from ...models.requests import ChatMessageRequest, ChatHistoryRequest
