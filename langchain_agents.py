...
class TourismMultiAgent:
    ...
    async def process_request(self, user_input: str) -> str:
        ...
        try:
            ...
            # Create system prompt for tourism context
            system_context = """
            You are an expert accessible tourism assistant for Spanish-speaking users. 
            Your goal is to help users plan accessible tourism experiences using specialized tools.
            
            Use the available tools in this order when appropriate:
            1. tourism_nlu - First analyze the user's intent and extract entities
            2. accessibility_analysis - Analyze accessibility requirements
            3. route_planning - Plan accessible routes
            4. tourism_info - Get current venue information
