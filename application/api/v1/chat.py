...
from shared.exceptions.exceptions import BackendCommunicationException, ValidationException
from application.models.requests import ChatMessageRequest, ChatHistoryRequest
